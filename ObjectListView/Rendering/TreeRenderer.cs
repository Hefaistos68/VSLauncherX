...
namespace BrightIdeasSoftware
{
	...
	public partial class TreeListView
	{
		...
		public class TreeRenderer : HighlightTextRenderer
		{
			...
			/// <param name="g"></param>
			/// <param name="r"></param>
			public override void Render(DrawListViewItemEventArgs e, System.Drawing.Graphics g, System.Drawing.Rectangle r)
			{
				...
				{
					int offset = base.DrawCheckBoxes(g, paddedRectangle);

					paddedRectangle.X += offset;
					paddedRectangle.Width -= offset;

					this.SubRenderer.RenderItem(e, g, paddedRectangle, this.RowObject);
				}
				else
				{
			...
			/// <param name="g"></param>
			/// <param name="r"></param>
			public override void Render(DrawListViewSubItemEventArgs e, System.Drawing.Graphics g, System.Drawing.Rectangle r)
			{
				this.DrawBackground(g, r);
				...
				if (this.SubRenderer != null)
				{
					...
					this.SubRenderer.RenderSubItem(e, g, paddedRectangle, this.RowObject);
				}
				else
				{
					this.DrawImageAndText(g, paddedRectangle);
